...
- Add input validation for array size limits
- Replace fixed-size arrays with `std::vector`
- Add comments explaining important logic blocks
- Add sample input and output for each program
- Remove generated executable files from version control

## Author

Created as part of C++ programming practice.
